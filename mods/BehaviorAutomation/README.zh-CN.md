...
<p align="center"><a href="https://github.com/SZnine/stardew-valley-mod/releases/tag/behavior-automation-v2.2.1">下载 2.2.1</a> · <a href="https://www.nexusmods.com/stardewvalley/mods/52289">Nexus Mods</a> · <a href="#操作">操作</a> · <a href="docs/CHANGELOG.zh-CN.md">更新记录</a></p>
...
松开鼠标开始作业，新选区替换旧任务。短暂手动移动时优先响应玩家，松开后继续作业。
...
**F8** 面板包含三个独立页面。点击图标切换，高亮表示启用；每页支持**全选**与**清空**。
